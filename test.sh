...
gnome-terminal -x sh -c '((sleep 60s && kill -9 $$)&); echo Running: java Client localhost peer_3 BACKUP penguin.jpg 1; java Client localhost peer_3 BACKUP penguin.jpg 1; exec bash'
